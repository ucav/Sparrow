// Inherit the same lint policy as the main crate (this code was extracted from
// it). Keeps `clippy --all-targets -- -D warnings` green across the workspace.
#![allow(
...
use sparrow_core::event::{StopReason, TokenUsage};
